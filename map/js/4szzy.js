...
function init2() {
	...
	$("#OL_Icon_46").append("<div class='actinfo'><div class='local'>雅致楼</div><i class='iconfontzacao'>&#xe600;</i> <span> <marquee scrollamount='3'>TO:小确幸 虽然你长得不帅，还很黑（简直黑出新高度了）但是，还是对你有那么一种特别的感觉，情绪会随着你的变化而变化，会总想找你聊天。爱你！我的暖宝宝！  #特别的爱给特别#</marquee></span></div>");
