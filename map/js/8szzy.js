...
function init() {
	...
	map.setCenter(new OpenLayers.LonLat(105.75546, 32.32862), 2);
...
function init2() {
	var msg = "" +
		...
		"markersLayer.addMarker(mark);" +
		"var mark = new OpenLayers.Marker(new OpenLayers.LonLat(105.75385, 32.32761), icon.clone());" + 
		"mark.events.register('touchstart', mark, function(evt) { markerEvent(evt, 79, '', '日新楼', 105.75385, 32.32761); });" +
		"markersLayer.addMarker(mark);";
		// "var mark = new OpenLayers.Marker(new OpenLayers.LonLat(105.75106, 32.33362), icon.clone());" +
		// 	"mark.events.register('touchstart', mark," +
		// 	"function(evt) {" +
		// 		"markerEvent(evt, 73, '', '雅志楼', 105.75106, 32.33362);" +
		// 	"});" +
		// 	"markersLayer.addMarker(mark);"+
		...
		// 	"markersLayer.addMarker(mark);"+
		// 	"var mark = new OpenLayers.Marker(new OpenLayers.LonLat(105.73889, 32.33488), icon.clone()); mark.events.register('touchstart', mark, function(evt) { markerEvent(evt, 170, '', '图书馆', 105.73889, 32.33488); }); markersLayer.addMarker(mark); ";
	showData(msg);
	// $("#OL_Icon_52").append("<div class='actinfo'><div class='local'>雅致楼</div><i class='iconfontzacao'>&#xe600;</i> <span> <marquee scrollamount='3'>TO:小确幸 虽然你长得不帅，还很黑（简直黑出新高度了）但是，还是对你有那么一种特别的感觉，情绪会随着你的变化而变化，会总想找你聊天。爱你！我的暖宝宝！  #特别的爱给特别#</marquee></span></div>");
	// $("#OL_Icon_56").append("<div class='actinfo'><div class='local'>大运广场</div><i class='iconfontzacao'>&#xe606;</i> <span> <marquee scrollamount='3'>我有一本小黄书 [地点 深职/深大/信息（全校）]</marquee></span></div>");
	// $("#OL_Icon_60").append("<a id='checkParent' href='8.1chatroom.html' class='actinfo courseinfo'><div class='local'>图书馆</div><i class='iconfontzacao'>&#xe605;</i> <span> <marquee scrollamount='3'>第1~2节 嵌入式系统应用[图书馆报告厅]</marquee></span><div class='badge badge-danger'>8</div></a>");
	// $("#OL_Icon_54").append("<a id='checkParent' href='8.1chatroom.html' class='actinfo courseinfo'><div class='local'>图书馆</div><i class='iconfontzacao'>&#xe605;</i> <span> <marquee scrollamount='3'>第1~2节 嵌入式系统应用[图书馆报告厅]</marquee></span><div class='badge badge-danger'>8</div></a>");
    ...
    $("#OL_Icon_60").append("<a id='checkParent' href='8.1chatroom.html' class='actinfo courseinfo'><div class='local'>日新楼</div><i class='iconfontzacao'>&#xe605;</i> <span> <marquee scrollamount='3'>第1~2节 嵌入式系统应用[日新楼东401]</marquee></span><div class='badge badge-danger'>8</div></a>");
    $("#OL_Icon_54").append("<a id='checkParent' href='8.1chatroom.html' class='actinfo courseinfo'><div class='local'>日新楼</div><i class='iconfontzacao'>&#xe605;</i> <span> <marquee scrollamount='3'>第1~2节 嵌入式系统应用[日新楼东401]</marquee></span><div class='badge badge-danger'>8</div></a>");
}
